...
class Event
{
     ...
     * @param  integer $ref                A numeric reference to store alongside the event (e.g the id of the object
     *                                     the event relates to)
     * @param  string  $recorded           A strtotime() friendly string of the date to use instead of NOW() for the
     *                                     created date
